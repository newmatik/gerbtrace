    ...
    <footer class="border-t border-neutral-200 dark:border-neutral-800">
      <UContainer>
        <div class="flex items-center justify-between py-4 text-sm text-neutral-500 dark:text-neutral-400">
          <span><a href="https://www.newmatik.com" target="_blank" class="hover:text-neutral-900 dark:hover:text-neutral-100 transition-colors">Gerbtrace by Newmatik</a></span>
