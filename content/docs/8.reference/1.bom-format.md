---
title: BOM File Format
description: Specification for BOM file import including supported formats, column mapping, and examples.
---
...
| Field | Required | Recognized header names | Description |
|---|---|---|---|
...
| **Manufacturer Part** | No | `Manufacturer Part`, `MPN`, `MFPN`, `Manufacturer Part Number`, `Mfr Part`, `Mfg Part`, `Mfr PN`, `Mfg PN`, `Part No`, `Part Number` | Manufacturer part number (used for pricing lookup) |
